    ...
    for dataset in args.datasets:
        for shot in args.shots:
            ...
            for classifier in args.classifier:
                ...
                print(f"Running student training for {dataset} with {shot} shots, {pre_mode} pre-mode, {memory_selector} selector, {classifier} classifier ")
                ...
                student_cmd = (
                    ...
                    f"--default_root_dir ../results_rfs_student_bestcombo_Shot/results_rfs_student_{dataset}_{shot}shot_{pre_mode}_{classifier}_{memory_selector} "
